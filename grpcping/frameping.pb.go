...
var file_grpcping_frameping_proto_goTypes = []interface{}{
...
func file_grpcping_frameping_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_grpcping_frameping_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpcping_frameping_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
